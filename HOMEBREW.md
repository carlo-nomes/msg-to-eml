...
1. **Calculate SHA256** of your release tarball:
   ...
   ```bash
   curl -sL https://github.com/carlo-nomes/msg-to-eml/archive/v1.0.0.tar.gz | shasum -a 256
   ```
...
class MsgToEml < Formula
  ...
  homepage "https://github.com/carlo-nomes/msg-to-eml"
  url "https://github.com/carlo-nomes/msg-to-eml/archive/v1.0.0.tar.gz"
